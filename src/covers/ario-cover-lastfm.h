...
#ifndef __ARIO_COVER_LASTFM_H
#define __ARIO_COVER_LASTFM_H

#include "covers/ario-cover-provider.h"

G_BEGIN_DECLS

#define TYPE_ARIO_COVER_LASTFM         (ario_cover_lastfm_get_type ())
#define ARIO_COVER_LASTFM(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), TYPE_ARIO_COVER_LASTFM, ArioCoverLastfm))
#define ARIO_COVER_LASTFM_CLASS(k)     (G_TYPE_CHECK_CLASS_CAST((k), TYPE_ARIO_COVER_LASTFM, ArioCoverLastfmClass))
#define IS_ARIO_COVER_LASTFM(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), TYPE_ARIO_COVER_LASTFM))
